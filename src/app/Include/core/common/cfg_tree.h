...
#define CFGTREE_BUFF_CHAN_NAME_CONFIG   ((CFGTREE_BUFF_CONFIG) | (CFGTREE_CHAN_NAME_CONFIG))
#define CFGTREE_BUFF_CHAN_VAL_CONFIG    ((CFGTREE_BUFF_CONFIG) | (CFGTREE_CHAN_VAL_CONFIG))
